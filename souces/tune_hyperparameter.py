...
def tuning(data_500_tune, labels_500_tune):
    ...
    for max_k in range(2, 12):
        ...
        if f1 > max_f1:
            max_f1 = f1
            best_k_nn = max_k
    print('Best max_k with 500 data: %d\n' % best_k_nn)
    ...
    print('Best max_depth with 500 data: %d\n' % best_max_depth)
    ...
    print('Best min_samples_split with 500 data: %d\n' % best_min_samples_split)
    ...
    print('Best max_feature with 500 data: %d\n' % max_feature)
